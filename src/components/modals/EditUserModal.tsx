...
export function EditUserModal({ children, user, name }: EditUserModalProps) {
  ...
  const handleSubmit = form.handleSubmit(async (formData) => {
    try {
      ...
      await updateUser(formattedFormData)
      ...
      <DialogContent className="z-50">
        ...
        <form noValidate onSubmit={handleSubmit}>
          <div className="grid gap-4">
            ...
            <Button className="ml-auto w-36" disabled={formState.isSubmitting} type="submit">
